...
let rez = "Неверное значение";
if ((dayNumber >= 1) && (dayNumber < 32)) {
  if ((dayNumber >= 1) && (dayNumber <= 10)) {
    rez = `Число ${dayNumber} попадает в 1 декаду месяца.`;
  } else if ((dayNumber >= 11) && (dayNumber <= 20)) {
    rez = `Число ${dayNumber} попадает в 2 декаду месяца.`;
  } else if ((dayNumber >= 21) && (dayNumber <= 31)) {
    rez = `Число ${dayNumber} попадает в 3 декаду месяца.`;
  }
}
console.log(rez);
